...
import { AllHotelContainer, Description, HotelContainer, Rooms, StyledContainer, Title, Unauthorized } from './style';
import Button from '../../../components/Form/Button';
import { getTicketByUserId } from '../../../services/paymentApi';
  ...
  useEffect(async() => {
    try {
      ...
      if (ticket.status === 'PAID') {
        ...
        return setUnauthorized(`Sua modalidade de ingresso não inclui hospedagem. 
        Prossiga para a escolha de atividades`);
      }
      setUnauthorized('Você precisa ter confirmado pagamento antes de fazer a escolha de hospedagem.');
    } catch (err) {
      setUnauthorized('Você precisa ter confirmado pagamento antes de fazer a escolha de hospedagem.');
      console.log(err);
    }
